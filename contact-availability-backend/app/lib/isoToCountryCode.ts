...
export const getCountryCode = (countryName: string): string | null => {
  ...
  const countryCode = isoToCodesByCountryName[normalizedName as keyof typeof isoToCodesByCountryName];
...
export const getSupportedCountries = (): string[] => {
  return Object.keys(isoToCodesByCountryName);
};

// Keep the old function name for backward compatibility
export const isoToCountryCode = getCountryCode;
